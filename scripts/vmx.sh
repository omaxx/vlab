...
IMG=/mnt/soft/junos/vmx/23.2R1/

echo "copy ${DEV}/re0 images"
rsync -h --progress --chmod=0664 ${IMG}/junos-vmx-x86-64-23.2R1.13.qcow2 ${VLAB}/${DEV}/re0
...
rsync -h --progress --chmod=0664 ${IMG}/junos-vmx-x86-64-23.2R1.13.qcow2 ${VLAB}/${DEV}/re1
...
rsync -h --progress --chmod=0664 ${IMG}/vFPC-20230502.img ${VLAB}/${DEV}/fpc0
rsync -h --progress --chmod=0664 ${IMG}/metadata-usb-fpc0.img ${VLAB}/${DEV}/fpc0

# echo "copy ${DEV}/fpc1 images"
# rsync -h --progress --chmod=0664 ${IMG}/vFPC-20230502.img ${VLAB}/${DEV}/fpc1
...
virt-install \
    ...
    --vcpus=1 \
    --import \
    --disk path=${VLAB}/${DEV}/re0/junos-vmx-x86-64-23.2R1.13.qcow2,bus=ide,format=qcow2 \
...
virt-install \
    ...
    --vcpus=1 \
    --import \
    --disk path=${VLAB}/${DEV}/re1/junos-vmx-x86-64-23.2R1.13.qcow2,bus=ide,format=qcow2 \
...
virt-install \
    ...
    --vcpus=3 \
    --import \
    --disk path=${VLAB}/${DEV}/fpc0/vFPC-20230502.img,bus=ide,format=raw \
